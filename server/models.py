...
class Project(Base):
    ...
    priority = Column(String(20), default="")              # 优先级: 高/中/低
    client_type = Column(String(50), default="")           # 目标客户端类型: web/app/mini_program
    time_dimension = Column(String(100), default="")       # 时间维度
    detail = Column(Text, default="")                      # 详细需求描述
    attachment = Column(String(500), default="")           # 附件
    url = Column(String(500), default="")                  # 网址
    quote = Column(Float, default=0)                        # 报价
    profit = Column(Float, default=0)                       # 利润
    payment_method = Column(String(500), default="")        # 支付方式
    duration = Column(String(500), default="")             # 工期
    progress = Column(String(50), default="待开始")          # 进度: 待开始/正在进行/已完成/需要交接
    is_outsourced = Column(String(10), default="否")        # 是否外包: 是/否
